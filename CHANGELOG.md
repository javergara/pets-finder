...
- **Esquema — cinco tablas nuevas**: `pets` (AD-01, **ya migrada** el 2026-08-15), `swipes` y `home_profiles` (AD-03), `matches` (AD-05) y `favorites` (AD-07). Las cuatro últimas están **escritas en `migrations/` y sin ejecutar**. Cada `.sql` tiene su test anti-drift (`tests/api/test_migracion_*.py`, cuatro) que lo compara columna a columna contra el modelo y exige que viajen el RLS y las constraints con su nombre.
